...
<section class="content-header">
	<div class="container-fluid">
		<div class="row mb-2">
		  <div class="col-sm-6">
			<h1>Grupo atributo</h1>
		  </div>
		  <div class="col-sm-6">
			<ol class="breadcrumb float-sm-right">
			  <li class="breadcrumb-item"><a href="<?php echo site_url('admin/dashboard') ?>">Dashboard</a></li>
			  <li class="breadcrumb-item active">Grupo atributo</li>
			</ol>
		  </div>
		</div>
	  </div><!-- /.container-fluid -->
		...
		<div class="row">
			  ...
			  <div class="card">
				<div class="card-header">
					<h3 class="card-title"><?= isset($data) ? 'Actualizar' : 'Nueva' ?> Grupo atributo</h3>
				</div>
				<!-- /.card-header -->
				<!-- form start -->
				<?php if (isset($data['id']) && $data['id']>0): ?>
					<form role="form" method="post" action="<?= site_url('admin/attributes/update/'. $data['id']) ?>"  enctype="multipart/form-data">
					<input name="_method" type="hidden" value="PUT">
				<?php else: ?>
					<form role="form" method="post" action="<?= site_url('admin/attributes/save') ?>"  enctype="multipart/form-data">
				<?php endif; ?>
					...
					<div class="card-footer">
						...
						<a href="<?= site_url('admin/attributes') ?>" class="btn btn-default">Volver</a>
					</div>
				</form>
			</div>
			<!-- /.card -->
