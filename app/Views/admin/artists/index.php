		  	...
		  	<div class="col-12">
				<div class="card">
					...
					<div class="card-tools">
						<form method='get' action="<?= site_url('admin/artists') ?>" id="searchForm">
			  ...
			  <!-- /.card-header -->
			  	<div class="card-body  p-0">
					  ...
					  <div class="row px-3">
						...
						<a href="<?= site_url('admin/artists/add') ?>" class="btn btn-success">Crear nuevo</a>
						</div>
                        ...
                        foreach ($alldata as $item) {
                            ...
                            <tr>
                                ...
                                <td class="center"  width="100">
                                    <a class="btn btn-info" href="<?php echo base_url('admin/artists/edit/' . $item['id']); ?>">
									<i class="fas fa-edit"></i>
                                    </a>
                                    <a class="btn btn-danger delete-row" href="#" data-url="<?php echo base_url('admin/artists/delete/' . $item['id']); ?>">
