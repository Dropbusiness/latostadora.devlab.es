        ...
        this.onDelete = function ( event )
        {
            ...
            if ( null === document.getElementById( 'bootstrap-confirm-delete-container' ) )
            {
                ...
                <div id="bootstrap-confirm-delete-container">
                    <div id="bootstrap-confirm-dialog" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 id="bootstrap-confirm-dialog-heading" class="modal-title"></h5>
                                ...
                                <div class="modal-footer justify-content-between">
                                    <a id="bootstrap-confirm-dialog-cancel-delete-btn" type="button" class="btn btn-default" data-dismiss="modal">Cancel</a>
                                    <a id="bootstrap-confirm-dialog-delete-btn" href="#" class="btn btn-danger">Delete</a>
                                </div>
                            </div>
                        </div>
                    </div>
